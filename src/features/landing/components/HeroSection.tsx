      ...
      <div className="flex flex-col items-start text-left space-y-6 max-w-2xl">
        ...
        <div className="flex flex-col w-full max-w-md gap-3 pt-2">
          ...
          <Button
            variant="secondary"
            size="lg"
            className="h-12 text-[15px] font-medium w-full bg-blue-50 hover:bg-blue-100 text-blue-900 border border-blue-200 justify-start pl-4 group rounded-full"
            asChild
          >
            <Link to="/admin/login" className="flex items-center">
              <div className="bg-blue-200 p-1.5 rounded-full mr-3">
                <CheckCircle className="h-4 w-4 text-blue-600" />
              </div>
              TPO Login
              <ChevronRight className="ml-auto h-4 w-4 text-blue-400 group-hover:text-blue-600" />
            </Link>
          </Button>
          <div className="flex items-center gap-4 pl-2 pt-1">
            <span className="text-xs text-zinc-400 flex items-center gap-1">
              <CheckCircle className="h-3 w-3 text-emerald-500" /> Zero setup
              fee
            </span>
            <span className="text-xs text-zinc-400 flex items-center gap-1">
              <CheckCircle className="h-3 w-3 text-emerald-500" /> GDPR
              Compliant
            </span>
          </div>
        </div>
      ...
      <div className="relative w-full max-w-[500px] lg:max-w-none mx-auto aspect-square md:aspect-[4/3] lg:aspect-square bg-zinc-50/50 rounded-3xl border border-zinc-200/50 p-6 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative w-full bg-white rounded-2xl border border-zinc-200 shadow-xl shadow-zinc-200/40 p-5 space-y-4 z-20">
          ...
          <div className="pt-2">
            <Button
              size="sm"
              className="w-full bg-zinc-900 hover:bg-black text-white h-9 text-xs rounded-lg font-medium"
            >
              Apply Now
            </Button>
          </div>
