    ...
    return (
        <section className="py-24 bg-zinc-50 border-y border-zinc-100/50">
            <div className="text-center mb-20 space-y-4">
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-zinc-900">With us, placement tracking is easy.</h2>
                <p className="text-xl text-zinc-500">Effortless scheduling for students and recruiters.</p>
            </div>
            ...
            <div className="container mx-auto px-6 md:px-12 grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-8 rounded-[2rem] border border-zinc-200/80 shadow-sm flex flex-col h-[500px] relative overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="h-8 w-8 bg-zinc-100 rounded-md flex items-center justify-center text-xs font-bold text-zinc-500 mb-6 font-mono">01</div>
                    <h3 className="text-2xl font-bold tracking-tight mb-3">Connect your profile</h3>
                    <p className="text-zinc-500 leading-relaxed mb-8">
                        We'll handle all the cross-referencing, so you don't have to worry about updating resumes everywhere.
                    </p>
                ...
                {/* Card 02: Preferences */}
                <div className="bg-white p-8 rounded-[2rem] border border-zinc-200/80 shadow-sm flex flex-col h-[500px] relative overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="h-8 w-8 bg-zinc-100 rounded-md flex items-center justify-center text-xs font-bold text-zinc-500 mb-6 font-mono">02</div>
                    <h3 className="text-2xl font-bold tracking-tight mb-3">Set your availability</h3>
                    <p className="text-zinc-500 leading-relaxed mb-8">
                        Want to block off exam weeks? Set up your buffers? We make that easy.
                    </p>
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-zinc-50 rounded-xl border border-zinc-100 p-4 space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex gap-2 text-xs text-zinc-500 border border-zinc-200 rounded px-2 py-1 bg-white">9:00am - 5:00pm</div>
                        </div>
                        <div className="flex items-center justify-between opacity-50">
                            ...
                            <div className="flex gap-2 text-xs text-zinc-500 border border-zinc-200 rounded px-2 py-1 bg-white">Unavailable</div>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-4 rounded-full bg-zinc-800 relative">
                            ...
                            <div className="flex gap-2 text-xs text-zinc-500 border border-zinc-200 rounded px-2 py-1 bg-white">10:00am - 4:00pm</div>
                        </div>
                    </div>
                </div>
                ...
                {/* Card 03: Interview */}
                <div className="bg-white p-8 rounded-[2rem] border border-zinc-200/80 shadow-sm flex flex-col h-[500px] relative overflow-hidden group hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div className="h-8 w-8 bg-zinc-100 rounded-md flex items-center justify-center text-xs font-bold text-zinc-500 mb-6 font-mono">03</div>
                    <h3 className="text-2xl font-bold tracking-tight mb-3">Start Interviewing</h3>
                    <p className="text-zinc-500 leading-relaxed mb-8">
