export function TrustedBy() {
  return (
    <section className="py-10 border-t border-[#c49a1b]/10 text-center">
      <p className="text-sm font-semibold text-[#c49a1b]/70 mb-12">
        Trusted by fast-growing companies around the campus
      </p>
