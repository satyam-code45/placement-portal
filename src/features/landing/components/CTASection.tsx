...
export function CTASection() {
    return (
        <section className="py-6 px-2 w-full max-w-[1000px] mx-auto">
            <div className="relative bg-white rounded-3xl border border-zinc-200/80 shadow-sm overflow-hidden text-center mx-auto w-full py-10 md:py-12">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between px-6 md:px-12 lg:px-20 gap-8">
                    ...
                    <div className="flex flex-col items-center md:items-end gap-6 flex-shrink-0">
                        <div className="flex items-center gap-3">
                            <Button
                                size="lg"
                                className="h-10 px-6 rounded-full bg-zinc-900 hover:bg-black text-white font-medium text-sm shadow-md"
                                asChild
                            >
                            ...
                            <Button
                                variant="outline"
                                size="lg"
                                className="h-10 px-6 rounded-full border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-900 font-medium text-sm"
                                asChild
                            >
                                <Link to="/contact">
                                    Talk to sales
                        ...
                        <div className="flex items-center gap-4 opacity-80 scale-90 origin-right">
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="font-bold text-zinc-900 text-[10px]">G2 High Performer</span>
                            </div>
                            <div className="h-3 w-[1px] bg-zinc-200"></div>
                            <div className="flex items-center gap-1.5">
                                <Trophy className="h-3 w-3 text-zinc-400" />
                                <span className="font-bold text-zinc-900 text-[10px]">#1 Education App</span>
                            </div>
                        </div>
                    </div>
