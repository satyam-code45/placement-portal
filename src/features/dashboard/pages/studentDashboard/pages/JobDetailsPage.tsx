...
export default function JobDetailsPage() {
    ...
    applyMutation.mutate(id, {
      onSuccess: () => {
        ...
        toast.success("Application Submitted!", {
          description: `You have successfully applied to ${job?.title}`,
        });
      },
      onError: (error) => {
        toast.error("Error", {
  ...
  if (!job) {
    return (
      <AppLayout>
        <Card>
          <CardContent className="p-12 text-center">Job not found</CardContent>
        </Card>
      </AppLayout>
    );
  }
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  ...
                  <Badge variant="outline" className={eligibilityBadge.class}>
                    <eligibilityBadge.icon className="h-3 w-3 mr-1" />
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={
                    hasApplied || job.eligibilityStatus === "not-eligible"
                  }
                >
          ...
          <div className="space-y-4">
            <Card>
              ...
              <CardContent className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">No Backlogs</span>
                  <span className="font-medium">
                    {job.eligibility.noBacklogs ? "Required" : "Allowed"}
                  </span>
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center gap-2">
                  ...
                  <span>{format(new Date(job.deadline), "PPP")}</span>
                </div>
              </CardContent>
            </Card>
          </div>
